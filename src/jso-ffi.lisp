...
(export '(jso::to-list))
(defun to-list (jso &optional (null-stamp nil))
  (let ((raw))
...
#+todo
(defun {null} (x &optional (s :|null|)) 
  (if (jscl::js-null-p x) s x))

;;; (map 'list  (lambda (x) ({null} x nil)) (#j:Object:values #j:O))
;;; (map 'list  #'{null} (#j:Object:values #j:O))

;;; get Object.values. null replace with symbol :|null|
;;; todo: rewrite js-undefined-p as (=== (typeof ,x) "undefined")
;;; there is a problem with form {a: null, b: undefined}-  not being caught by predicates
;;; todo: rewrite with %lmapcar
#+todo
(defun {v} (o)
  (mapcar #'{null}
